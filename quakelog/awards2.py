...
_AWARDS = [
		...
		(Award("Hard Worker", None, "Most frags and highest damage rate"),
				max('kill_count') + max('dmg_kill_ratio')),
		...
		(Award("Lucky Bastard", None, "Least damage per frag ratio and deaths"),
