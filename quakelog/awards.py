...
#(5, 'flag_assist_returns', Award("JIT Clucking Hen", None, "most flag assist returns")),
	...
	(70, 'chat_length', Award("Chatterbox", None, "most chatted characters")),
...
_MAX_WEAPONS = [
	...
	(0.35, 'rocketlauncher', 'hitrate', Award("Cruise Missile", None, "Best hitrate with rocket launcher")),
	...
	(170, 'plasmagun', 'shots', Award("Plasmatic", None, "Most shots with plasma gun")),
